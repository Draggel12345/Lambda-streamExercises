...
public class Lab {
    ...
    public void exercise3() {
        ...
        UnaryOperator<String> listToUpperCase = s -> s.toUpperCase();
        System.out.println(listToUpperCase.apply(list.toString()));
    ...
    public void exercise9(){
        ...
        List<Person> newPersons = this.persons;
